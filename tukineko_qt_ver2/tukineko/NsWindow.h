...
//public QWidget,
class NsWindow : public java::awt::Panel_, public java::awt::event::MouseListener, public java::awt::event::ActionListener {
    Q_OBJECT
...
public:
    ...
    static void grabPixels(java::awt::Image_* img, int x, int y, int w, int h, QVector<quint32>& pix, int off, int scansize);
//    {
//        Q_UNUSED(img)
//        Q_UNUSED(x)
//        Q_UNUSED(y)
...
//        Q_UNUSED(scansize)
//    } //FIXME:
    java::awt::Image_* createImage(int w, int h, const QVector<quint32> &pix, int off, int scan);
